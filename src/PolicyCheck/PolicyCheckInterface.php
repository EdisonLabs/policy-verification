...
interface PolicyCheckInterface
{
   ...
   *
   * @return string
   *   The policy check category name.
   */
   ...
   *
   * @return int
   *   Constants indicating the risks low, medium, high or critical.
   */
   ...
   *
   * @return string
   *   The policy compliant check result message.
   */
   ...
   *
   * @return string
   *   The policy not compliant check result message.
   */
   ...
   *
   * @return array
   *   Returns a list containing the action messages.
   */
