...
/**
 * Example of policy check with skip check class to be used for tests.
 */
class ExamplePolicyCheckSkipCheck extends AbstractPolicyCheckBase
{
   ...
   */
    ...
    {
        return 'Example policy check with skip check';
    }
    ...
    {
        return 'This is an example of a policy check with skip check';
    }
